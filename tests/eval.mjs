...
const criteria = [
  ['Hero carries the new jargon and deck subline', /We turn business problems\s*into\s*digital solutions/.test(text) && has('We find what’s slowing your business down', 'then design and build the system to fix it')],
  ...
  ['Sections follow the agreed order', order('We turn business problems', 'Before & after', 'What usually gets in the way?', 'What can we build?', 'Connected to the work', 'Start with the problem.', 'What it could look like.', 'Follow the current.', 'That’s exactly where we start.')],
